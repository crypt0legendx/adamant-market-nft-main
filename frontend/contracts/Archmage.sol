...
contract Archmage is ERC721URIStorage {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint256 m_nMintPrice = 50000 * 10**9;
    uint256 m_nUpgradePrice = 25000 * 10**9;
    uint256 m_nTotalSupply = 2000;
    address m_addrMaster;
    address m_addrOwner;
    uint256 public m_nBurnId;
    string m_strBaseUri = "https://gateway.pinata.cloud/ipfs/Qme3n8V2jTtpdYeX4gKbKVDVr7vmjfJCvAmAg2HRo7KJnd";
    mapping(address => uint256[]) m_mapAddressToTokens;

    constructor(address addrMaster) ERC721("Archmage", "ARCHMAGE"){
